...
public class DefaultBrokerClientSocketTest {
  ...
  public void testRequestResponse() {
    ...
    DefaultBrokerSocket socket = new DefaultBrokerSocket(payload -> transformed, () -> mock);
  ...
  public void testRequestChannel() {
    ...
    DefaultBrokerSocket socket =
        new DefaultBrokerSocket(
            payload -> transformed,
            () ->
                new AbstractRSocket() {
                  @Override
