 ...
 */
package com.netifi.broker.metrics;

import org.junit.Ignore;

@Ignore
public class BrokerMeterRegistryTest {
  /*@Test
  public void testMetrics() throws InterruptedException {
    ...
    */
  /* NetifiMeterRegistry registry =
      new NetifiMeterRegistry(NetifiSpectatorConfig.defaultInstance(), client);
  ...
  public void testMetricsThroughBrokerWithNetifi() throws InterruptedException {
    */
  /*
  BrokerClient netifi = BrokerClient
                      .builder()
                      .group("netifi.metrics.test")
                      .accessKey(7685465987873703191L)
                      .accessToken("PYYgV9XHSJ/3KqgK5wYjz+73MeA=")
  ...
  BrokerSocket socket = netifi.connect("netifi.metrics").block();
