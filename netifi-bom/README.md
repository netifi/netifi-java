# Netifi Java Bill Of Material Project
...
Next, add your dependencies to the relevant netifi projects as usual, except without a
`<version>`:
...
dependencies {
     // import BOM
     implementation platform('com.netifi:netifi-bom:Palladium-BUILD-SNAPSHOT')
...
dependencyManagement {
     imports {
          mavenBom "com.netifi:netifi-bom:1.6.1"
     }
}
```
