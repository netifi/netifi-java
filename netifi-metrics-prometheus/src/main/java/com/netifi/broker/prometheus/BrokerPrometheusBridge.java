...
@Named("Bridge")
public class BrokerPrometheusBridge implements MetricsSnapshotHandler {
  private static final Logger logger = LoggerFactory.getLogger(BrokerPrometheusBridge.class);
  ...
  public static void main(String... args) {
    ...
    Integer bindPort = Integer.getInteger("netifi.metricsBindPort");
    String metricsUrl = System.getProperty("netifi.metricsUrl");
